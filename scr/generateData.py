...
''' data with one correlated dimension'''
...
class SwitchingRegression:
    ...
    def generateData(self):
        ...
        y_axis_regime1 = np.column_stack(np.array([a_1, b_1, c_1, 0, 0])).dot(x_regime1[:5, :])
        ...
        np.savetxt("out.csv", self.data, delimiter=",")

    def load_data(self):
        self.data = genfromtxt('out.csv', delimiter=',')
        print self.data
